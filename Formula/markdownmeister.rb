class AnotherMarkdownEditor < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/yetanotherchris/another-markdown-editor/releases/download/v0.0.96/ameditor-0.0.96-macos-arm64.zip"
      sha256 "21da416689a19e6d2bbd9fb6e084fea350ca7eb56bba8308a915dd08c584d808"
    else
      url "https://github.com/yetanotherchris/another-markdown-editor/releases/download/v0.0.96/ameditor-0.0.96-macos-x64.zip"
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      url "https://github.com/yetanotherchris/another-markdown-editor/releases/download/v0.0.96/ameditor-0.0.96-linux-x64.AppImage"
  ...
  def install
    if OS.mac?
      ...
      bin.install "ameditor-0.0.96-linux-x64.AppImage" => "ameditor"
    end
  end
